...
// CredentialsEnc applies equality check predicate on the "credentials_enc" field. It's identical to CredentialsEncEQ.
func CredentialsEnc(v string) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldCredentialsEnc, v))
}
...
// CredentialsEncEQ applies the EQ predicate on the "credentials_enc" field.
func CredentialsEncEQ(v string) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldCredentialsEnc, v))
}

// CredentialsEncNEQ applies the NEQ predicate on the "credentials_enc" field.
func CredentialsEncNEQ(v string) predicate.Account {
	return predicate.Account(sql.FieldNEQ(FieldCredentialsEnc, v))
}

// CredentialsEncIn applies the In predicate on the "credentials_enc" field.
func CredentialsEncIn(vs ...string) predicate.Account {
	return predicate.Account(sql.FieldIn(FieldCredentialsEnc, vs...))
}

// CredentialsEncNotIn applies the NotIn predicate on the "credentials_enc" field.
func CredentialsEncNotIn(vs ...string) predicate.Account {
	return predicate.Account(sql.FieldNotIn(FieldCredentialsEnc, vs...))
}

// CredentialsEncGT applies the GT predicate on the "credentials_enc" field.
func CredentialsEncGT(v string) predicate.Account {
	return predicate.Account(sql.FieldGT(FieldCredentialsEnc, v))
}

// CredentialsEncGTE applies the GTE predicate on the "credentials_enc" field.
func CredentialsEncGTE(v string) predicate.Account {
	return predicate.Account(sql.FieldGTE(FieldCredentialsEnc, v))
}

// CredentialsEncLT applies the LT predicate on the "credentials_enc" field.
func CredentialsEncLT(v string) predicate.Account {
	return predicate.Account(sql.FieldLT(FieldCredentialsEnc, v))
}

// CredentialsEncLTE applies the LTE predicate on the "credentials_enc" field.
func CredentialsEncLTE(v string) predicate.Account {
	return predicate.Account(sql.FieldLTE(FieldCredentialsEnc, v))
}

// CredentialsEncContains applies the Contains predicate on the "credentials_enc" field.
func CredentialsEncContains(v string) predicate.Account {
	return predicate.Account(sql.FieldContains(FieldCredentialsEnc, v))
}

// CredentialsEncHasPrefix applies the HasPrefix predicate on the "credentials_enc" field.
func CredentialsEncHasPrefix(v string) predicate.Account {
	return predicate.Account(sql.FieldHasPrefix(FieldCredentialsEnc, v))
}

// CredentialsEncHasSuffix applies the HasSuffix predicate on the "credentials_enc" field.
func CredentialsEncHasSuffix(v string) predicate.Account {
	return predicate.Account(sql.FieldHasSuffix(FieldCredentialsEnc, v))
}

// CredentialsEncEqualFold applies the EqualFold predicate on the "credentials_enc" field.
func CredentialsEncEqualFold(v string) predicate.Account {
	return predicate.Account(sql.FieldEqualFold(FieldCredentialsEnc, v))
}

// CredentialsEncContainsFold applies the ContainsFold predicate on the "credentials_enc" field.
func CredentialsEncContainsFold(v string) predicate.Account {
	return predicate.Account(sql.FieldContainsFold(FieldCredentialsEnc, v))
}
