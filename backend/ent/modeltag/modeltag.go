...
const (
	// Label holds the string label denoting the modeltag type in the database.
	Label = "model_tag"
	...
	EdgePrices = "prices"
	// Table holds the table name of the modeltag in the database.
	Table = "model_tags"
	// PricesTable is the table that holds the prices relation/edge.
	PricesTable = "model_prices"
	// PricesInverseTable is the table name for the ModelPrice entity.
	// It exists in this package in order to avoid circular dependency with the "modelprice" package.
	PricesInverseTable = "model_prices"
	// PricesColumn is the table column denoting the prices relation/edge.
	PricesColumn = "tag_id"
)

// Columns holds all SQL columns for modeltag fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the ModelTag queries.
