...
func (arq *AnnouncementReadQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (arq *AnnouncementReadQuery) FirstIDX(ctx context.Context) int {
...
func (arq *AnnouncementReadQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (arq *AnnouncementReadQuery) OnlyIDX(ctx context.Context) int {
...
func (arq *AnnouncementReadQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (arq *AnnouncementReadQuery) IDsX(ctx context.Context) []int {
	ids, err := arq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (arq *AnnouncementReadQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(announcementread.Table, announcementread.Columns, sqlgraph.NewFieldSpec(announcementread.FieldID, field.TypeInt))
	_spec.From = arq.sql
