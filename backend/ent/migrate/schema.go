...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "usage_status", Type: field.TypeString, Default: "completed"},
		{Name: "stream", Type: field.TypeBool, Default: false},
		{Name: "duration_ms", Type: field.TypeInt64, Default: 0},
		{Name: "first_token_ms", Type: field.TypeInt64, Default: 0},
		{Name: "user_agent", Type: field.TypeString, Default: ""},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[38], UsageLogsColumns[40]},
			},
			{
				Name:    "usage_log_model_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[1], UsageLogsColumns[40]},
			},
			{
				Name:    "usage_log_user",
				Unique:  false,
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[42], UsageLogsColumns[40]},
			},
			{
