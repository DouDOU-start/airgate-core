	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[34], UsageLogsColumns[36]},
			},
			{
				Name:    "usage_log_model_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[1], UsageLogsColumns[36]},
			},
			{
				Name:    "usage_log_user",
				Unique:  false,
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[38], UsageLogsColumns[36]},
			},
			{
