...
func (pu *ProxyUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *ProxyUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (puo *ProxyUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *ProxyUpdateOne {
