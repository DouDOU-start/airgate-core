...
// Client 是旧版通用插件协议 v2 的 gRPC 客户端。
type Client struct {
	ctx  context.Context
...
// Core 侧只设置 Client，测试辅助进程可设置 Impl。
type GRPCPlugin struct {
	goplugin.NetRPCUnsupportedPlugin
	Impl Plugin
}

func (*GRPCPlugin) GRPCClient(ctx context.Context, _ *goplugin.GRPCBroker, conn *grpc.ClientConn) (any, error) {
