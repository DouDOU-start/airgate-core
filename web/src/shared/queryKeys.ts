export const queryKeys = {
  ...
  modelMarket: (...args: unknown[]) => ['model-market', ...args] as const,
  ...
  healthMonitorOverview: (...args: unknown[]) => ['health-monitor-overview', ...args] as const,
  healthMonitorEntities: (...args: unknown[]) => ['health-monitor-entities', ...args] as const,
  channelStatusOverview: (...args: unknown[]) => ['channel-status-overview', ...args] as const,
  channelStatusGroups: (...args: unknown[]) => ['channel-status-groups', ...args] as const,
  ...
  inviteMe: () => ['invite-me'] as const,
  inviteMyInvitees: (...args: unknown[]) => ['invite-my-invitees', ...args] as const,
  inviteMyLogs: (...args: unknown[]) => ['invite-my-logs', ...args] as const,
